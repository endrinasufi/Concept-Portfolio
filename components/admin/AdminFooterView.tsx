  ...
  return (
    <form onSubmit={(e) => void save(e)} className="space-y-5">
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          <h1>Footer</h1>
          <p>Edit all public footer copy and links.</p>
        </div>
        <button
          type="submit"
      ...
      <section className="admin-card space-y-3 p-4 md:p-5">
        <div>
          ...
          <p className="mt-1 text-xs text-muted">
            Large title at the bottom of the page. Use new lines for each line.
          </p>
        </div>
      ...
      <section className="admin-card space-y-3 p-4 md:p-5">
        <div>
          ...
          <p className="mt-1 text-xs text-muted">
            Column titles and contact details.
          </p>
        </div>
      ...
      <section className="admin-card space-y-3 p-4 md:p-5">
        <div className="flex items-start justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-xs text-muted">
              Add, remove, or edit networks. If URL is empty, the name shows without a link.
            </p>
          </div>
          <button
            type="button"
      ...
      <section className="admin-card space-y-3 p-4 md:p-5">
        <div className="flex items-start justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-xs text-muted">
              Footer navigation links. Use internal paths like /branding.
            </p>
          </div>
          <button
            type="button"
      ...
      <section className="admin-card space-y-3 p-4 md:p-5">
        <div>
          ...
          <p className="mt-1 text-xs text-muted">
            Name on the left. © year is generated automatically.
          </p>
        </div>
        <label className="block text-xs">
